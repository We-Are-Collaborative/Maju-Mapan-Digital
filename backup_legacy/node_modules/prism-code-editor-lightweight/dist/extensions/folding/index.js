import { a as createTemplate, n as numLines, l as languageMap } from "../../index-MBlAXvVu.js";
import { getLineBefore } from "../../utils/index.js";
import { c as addListener, b as getLineEnd } from "../../local-BXkeW3T1.js";
...
const readOnlyCodeFolding = (...providers) => {
  ...
  const toggleFold = (line) => {
    ...
    const addFold = (line2) => {
      ...
      if (!expanded) foldedRanges.add([start2, end]);
    };
