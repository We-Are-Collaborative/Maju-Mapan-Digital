...
import { E as u } from "./index-DI9T3iLd.js";
import { jsxs as a, jsx as l } from "react/jsx-runtime";
import { useState as s, useCallback as C } from "react";
import { t as h, A as f, C as x, B as m, k as v } from "./RichTextEditor-KP2Rgcqe.js";
const L = u.create({
  name: "color",
  addOptions() {
    return {
...
function g(t) {
  ...
  return /* @__PURE__ */ a("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ l(f, { tooltip: t == null ? void 0 : t.tooltip, disabled: t == null ? void 0 : t.disabled, action: n, tooltipOptions: t == null ? void 0 : t.tooltipOptions, children: /* @__PURE__ */ l("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ l(b, { fill: e || t.initialDisplayedColor }) }) }),
    /* @__PURE__ */ l(
      x,
      {
        selectedColor: e,
