...
export default function FileUpload({
    ...
    const displayName = currentFile?.name || currentMedia?.file_name || currentMedia?.name || 'Unknown file';
    const displaySize = currentFile?.size || currentMedia?.size || 0;
    const displayImageUrl = previewUrl || currentMedia?.preview_url || currentMedia?.original_url;
    const displayIsImage = currentFile ? currentFile.type.startsWith('image/') : currentMedia ? currentMedia.mime_type?.startsWith('image/') : false;
